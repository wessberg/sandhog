import {ICocService} from "./i-coc-service";
...
reported by contacting any of the code of conduct enforcers: ${this.contributorService.formatContributorNames(cocEnforcers, true)}.
